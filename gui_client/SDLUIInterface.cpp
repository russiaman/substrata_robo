...
// flag; SDLClient.cpp's main loop is what actually draws the ImGui window and forces its input-capture flags on while gaussian_splat_lod_build_in_progress is true (see the usages of that field there).
